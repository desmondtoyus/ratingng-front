...
class Footer extends Component {
   ...
   <Col md={2}></Col>
   <Col md={2}> <Link to ="/" className="menu" >Terms & Conditions</Link></Col>
              ...
              <footer style={{width: '100%', backgroundColor: '#2F313D', position: 'relative', zIndex: '2'}}>
                  <div style={{height: '50px', width: '100%', borderTop: '1px solid #414354', backgroundColor: '#2F313D'}}>
                    <span style={{float: 'left', paddingTop: '10px', marginLeft:'10px'}}>
                      <img src={require('../../assets/favicon.png')}  alt="heart icon" />
                    </span>
                    <span className="copyright" style={{marginLeft:'35%', marginRight:'auto'}}>Rating.Ng <p className="copyright">Copyright © 2018 </p><span style={{color: 'transparent'}}> </span></span>
